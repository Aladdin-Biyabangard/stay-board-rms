...
public class ModifierSelectionService {
    ...
    public List<OrderItemModifierEntity> buildOrderItemModifiers(
        ...
        validateSelections(menuItem, requestedIds);
    ...
    private void validateSelections(MenuItemEntity menuItem, List<Long> requestedIds) {
        Map<Long, Long> countByGroup = requestedIds.stream()
