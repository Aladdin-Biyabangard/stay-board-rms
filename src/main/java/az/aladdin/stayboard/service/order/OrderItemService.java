...
import az.aladdin.stayboard.service.menu.ModifierSelectionService;
...
public class OrderItemService extends HotelAwareService {
    ...
    public OrderItemResponse update(Long id, UpdateOrderItemRequest request) {
        return saveModifiedOrderItem(id, context -> {
            ...
            applyPricingWithExistingModifiers(context.entity(), menuItem);
            return order;
        });
    }
    ...
    public OrderItemResponse patch(Long id, PatchOrderItemRequest request) {
        return saveModifiedOrderItem(id, context -> {
            ...
            if (pricingMenuItem != null) {
                ...
                applyPricingWithExistingModifiers(context.entity(), pricingMenuItem);
            }
    ...
    private void applyPricingWithExistingModifiers(OrderItemEntity entity, MenuItemEntity menuItem) {
        BigDecimal modifierPriceDelta = OrderItemPricingSupport.sumModifierPriceDeltas(entity);
        OrderItemPricingSupport.applyPricing(entity, menuItem, modifierPriceDelta);
    }

    private void applyModifiersAndPricing(
        ...
        BigDecimal modifierPriceDelta = modifierSelectionService.sumPriceDeltas(modifiers);
        OrderItemPricingSupport.applyPricing(entity, menuItem, modifierPriceDelta);
    }
